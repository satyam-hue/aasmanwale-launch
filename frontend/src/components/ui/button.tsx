  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-display font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Adventure theme variants
        hero: "bg-gradient-to-r from-accent to-sunset-dark text-primary-foreground shadow-lg hover:shadow-glow-accent hover:scale-105 transform",
        ...
        sky: "bg-gradient-to-r from-primary to-sky-light text-primary-foreground shadow-md hover:shadow-glow-primary hover:scale-105 transform",
      },
      size: {
